...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\vitor\Meus Arquivos\Projetos\00 LaTeX\MapSamePopulation'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\vitor\Meus Arquivos\Projetos\00 LaTeX\MapSamePopulation\Scripts\deactivate.nu'
